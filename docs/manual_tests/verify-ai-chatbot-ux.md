...
- **Expected:** The AI acknowledges the request, "looks up" the schedule, and lists the titles and dates of upcoming posts.

### 4. Tool: Schedule Video (Happy Path)
- **Step 1:** Type "Schedule the video 'My Intro' for next Monday at 2 PM".
- **Expected:** 
  - The AI should identify the video (if uniquely named) or ask for clarification.
