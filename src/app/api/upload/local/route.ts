...
import { distributeSinglePlatform } from "@/lib/upload/server-distributor";
...
export async function POST(req: any) {
  return handlePlatformUploadRequest({
    ...
    uploadLogic: async ({ historyId, platform, stagedFileId, fileName, accountId, onProgress }) => {
      ...
      const p = fields.actualPlatform || platform || 'local1';
